...
const getOurStoryContent = (lang: string) => {
  const content = {
    tr: {
      ...
      servicesButtonText: "Hizmetlerimize Göz Atın"
    },
    en: {
      ...
      servicesButtonText: "Browse Our Services"
    },
    it: {
      ...
      servicesButtonText: "Sfoglia i Nostri Servizi"
    }
  };
      ...
      <div className="container mx-auto px-6 py-20">
        <div className="max-w-3xl mx-auto bg-brand-bg-surface rounded-xl shadow-xl p-8 md:p-12">
          ...
          <div className="mt-12 text-center">
            <Link
              href="/hizmetlerimiz" // Assuming this path is correct and doesn't need locale prefixing by Link itself
